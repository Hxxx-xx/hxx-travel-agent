...
import com.hxx.travel.agent.trip.model.TripEditRequestDTO;
import com.hxx.travel.agent.trip.model.TripRequestDTO;
import com.hxx.travel.agent.rag.service.VectorDbService;
...
public class TripPlannerAgentService {
    ...
    public DayEditDraftDTO generateDayEditDraft(TripEditRequestDTO request,
                                                  com.hxx.travel.agent.trip.model.DayPlanDTO targetDay) {
        if (apiKey == null || apiKey.isBlank()) {
    ...
    private String buildHumanPrompt(TripRequestDTO request, String guideContext, int dayCount) {
        ...
        sb.append("要求：\n");
        sb.append("1. 输出一个整体summary。\n");
        sb.append("2. 输出").append(dayCount).append("天的daily draft。\n");
        sb.append("3. 每天只给一个主要景点、一个餐饮建议和一条当天备注。\n");
        sb.append("4. tips保持简洁。\n");
        sb.append("5. day_index必须从1到").append(dayCount).append("。\n");
        sb.append("6. 如果额外备注里有\"想看日落\"\"不想早起\"这类明确要求，必须在days中体现。\n");
        sb.append("7. 每天的安排要符合\"轻松\"节奏，避免过满、避免太早出发。\n");
        sb.append("8. 餐饮建议尽量优先使用本地攻略上下文里已经出现的特色餐饮。\n");
        sb.append("9. 只返回JSON对象，不要返回任何额外说明，不要使用```json代码块。\n");
        sb.append("\nJSON结构示例：\n");
        sb.append("{\n");
        sb.append("  \"summary\": \"整体概述\",\n");
        sb.append("  \"tips\": [\"提示1\", \"提示2\"],\n");
        sb.append("  \"days\": [\n");
        sb.append("    {\n");
        sb.append("      \"day_index\": 1,\n");
        sb.append("      \"theme\": \"当天主题\",\n");
        sb.append("      \"spot_name\": \"主要景点\",\n");
        sb.append("      \"spot_description\": \"景点推荐理由\",\n");
        sb.append("      \"meal_name\": \"餐饮名称\",\n");
        sb.append("      \"meal_notes\": \"餐饮说明\",\n");
        sb.append("      \"daily_note\": \"当天备注\"\n");
        sb.append("    }\n");
        sb.append("  ]\n");
        sb.append("}\n");
